...
export const WETH9: { [chainId: number]: Token } = {
  ...
  // FIXME: 确定好WETH 地址之后修改
  [195]: new Token(195, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'),
  [196]: new Token(196, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether')
}
